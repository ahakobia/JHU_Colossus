...
read.csv("data/raw-data/HDR23-24_Statistical_Annex_GII_Table.csv") %>% 
...
mapping_file <- read.csv("data/country_mapping.csv")
...
write.csv(gender_index_df, file = file.path("data", "gender_index.csv"), row.names = FALSE)
